        ...
        <div class="main-content">
                            ...
                            <tr>
                                ...
                                <td class="action-cell">
                                    <button
                                        ...
                                        data-is-self="<?= (int)$u['user_id'] === (int)$_SESSION['user_id'] ? '1' : '0' ?>">Manage</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
            ...
            <div class="dashboard-section manage-users-branches manage-users-tab-panel" id="branchesPanel" role="tabpanel" aria-labelledby="branchesTab" data-management-panel="branches" hidden>
                <div class="section-header">
                    <div>
                        <h3>Branches</h3>
                        <p class="section-description">Create branches and deactivate them when they are no longer operational.</p>
                    </div>
                </div>
