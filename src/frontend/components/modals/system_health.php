    ...
    <div class="app-shell">
        ...
        <div class="main-content">
            ...
            <div class="health-summary">
                ...
                <article class="stat-card <?= $counts['critical'] ? 'warning' : 'success' ?>">
                    <div class="value"><?= $counts['critical'] ?></div>
                    <div class="label">Critical checks</div>
                    <div class="hint">Immediate action required</div>
                </article>
            </div>
            ...
            <section class="dashboard-section">
                ...
                <?php foreach ($checks as $check): ?>
                    <div class="health-check">
                        ...
                        <div>
                            <div class="health-category"><?= htmlspecialchars($check['category']) ?></div><strong><?= htmlspecialchars($check['name']) ?></strong>
            ...
            <section class="dashboard-section u-mt-15">
                <div class="section-header">
                    <div>
                        <h3>Recommended maintenance commands</h3>
                        <p class="section-description">Run these commands from the project directory when deploying or maintaining RetailMind.</p>
                    </div>
                </div>
