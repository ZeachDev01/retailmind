<?php
// components/invoice/reversals.php
        ...
        <div class="main-content">
            ...
            <div class="panel">
                <form method="GET" class="actions-row">
                    ...
                    <a class="btn btn-secondary" href="<?= htmlspecialchars(app_url('components/invoice/receipt.php')) ?>">Back to Receipts</a>
                </form>
            </div>
                            ...
                            <table>
                                ...
                                <?php foreach ($reversals as $row): ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= htmlspecialchars(app_url('components/invoice/reversals.php?sale_id=' . $row['sale_id'])) ?>">#<?= (int)$row['sale_id'] ?></a></td>
                                ...
                                <?php if (!$reversals): ?>
                                    <tr>
                                        <td class="u-empty-cell" colspan="5">No reversal records yet.</td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                        </div>
