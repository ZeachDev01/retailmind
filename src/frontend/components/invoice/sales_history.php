    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <div class="u-flex-center-wrap">
                <a class="btn btn-secondary" href="<?= htmlspecialchars(app_url('components/cashier/pos.php')) ?>"><i class="bi bi-arrow-left" aria-hidden="true"></i>Back</a>
        ...
        <div class="u-flex-between-wrap">
            ...
            <a class="btn" href="<?= htmlspecialchars(app_url('components/invoice/receipt.php')) ?>">Latest Receipt</a>
        </div>
        ...
        <div class="u-table-scroll">
            <table>
                ...
                <tr>
                    <td><a href="<?= htmlspecialchars(app_url('components/invoice/receipt.php?sale_id=' . $sale['sale_id'])) ?>">#<?= (int)$sale['sale_id'] ?></a></td>
