...
<body><div class="app-shell"><?php include __DIR__ . '/../includes/sidebar.php'; ?><main class="main-content"><div class="topbar"><div><h1>Forecast Data Readiness</h1><p class="page-subtitle">Review complete calendar history, zero-sales dates, eligibility, and data-quality warnings.</p></div><a class="btn" href="<?= htmlspecialchars(app_url('report/predictions.php')) ?>">Forecasts</a></div>
...
<?php if (!$rows): ?><tr><td colspan="11" class="muted" style="text-align:center">No readiness data. Run <code>sql/upgrade_random_forest_v2.sql</code> first.</td></tr><?php endif; ?></table></div></div>
</main></div></body></html>
