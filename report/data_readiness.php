...
<body><div class="app-shell"><?php include __DIR__ . '/../Sidebar/sidebar.php'; ?><main class="main-content"><div class="topbar"><div><h1>Forecast Data Readiness</h1><p class="page-subtitle">Review complete calendar history, zero-sales dates, eligibility, and data-quality warnings.</p></div><a class="btn" href="<?= htmlspecialchars(app_url('report/predictions.php')) ?>">Forecasts</a></div>
