<?php
// modules/invoice/receipt.php - CRUD interface for receipts
...
function receipt_render_details(array $sale, array $items): void {
    ...
    $receiptUrl = app_url('modules/invoice/receipt.php?sale_id=' . (int)$sale['sale_id']);
    ?>
    <div class="receipt-container">
        ...
        <div class="receipt-actions no-print">
            ...
            <a href="<?= htmlspecialchars(app_url('modules/invoice/receipt.php')) ?>" class="btn btn-secondary"><i class="bi bi-receipt"></i> Receipt History</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions-cell">
                                    ...
                                    <a href="<?= htmlspecialchars(app_url('modules/invoice/reversals.php?sale_id=' . $receipt['sale_id'])) ?>" class="btn-small btn-edit">Reverse</a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
    ...
    <div id="editModal" class="modal active">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="modal-close" title="Close" onclick="window.location.href='<?= htmlspecialchars(app_url('modules/invoice/receipt.php')) ?>'">&times;</button>
            </div>
            <div class="receipt-container">
                <form method="POST">
...
function viewReceipt(saleId) {
    const url = '<?= htmlspecialchars(app_url('modules/invoice/receipt.php')) ?>?action=view&sale_id=' + saleId + '&ajax=1';
...
async function legacyDeleteReceiptDisabled(saleId) {
    ...
    form.method = 'POST';
    form.action = '<?= htmlspecialchars(app_url('modules/invoice/receipt.php?action=delete&sale_id=')) ?>' + saleId;
