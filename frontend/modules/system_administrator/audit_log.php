<?php
// modules/system_administrator/audit_log.php
    ...
    <div class="main-content">
        ...
        <form method="GET" class="filter-section">
            ...
            <div class="filter-group">
                ...
                <a href="<?= htmlspecialchars(app_url('modules/system_administrator/audit_log.php')) ?>" class="clear-btn" style="text-align: center; text-decoration: none;">Clear</a>
            </div>
        </form>
