...
<body><div class="app-shell"><?php include __DIR__ . '/../modules/sidebar.php'; ?><main class="main-content"><div class="topbar"><div><h1>Forecast Analytics</h1><p class="page-subtitle">Backtesting, accuracy trends, feature importance, and product-level performance.</p></div><div class="u-flex-wrap"><a class="btn" href="<?= htmlspecialchars(app_url('report/forecast_exceptions.php')) ?>">Forecast exceptions</a><a class="btn" href="<?= htmlspecialchars(app_url('report/data_readiness.php')) ?>">Data readiness</a></div></div>
