...
<?php if (!$rows): ?><tr><td colspan="11" class="muted" style="text-align:center">No readiness data. Run <code>backend/sql/upgrade_random_forest_v2.sql</code> first.</td></tr><?php endif; ?></table></div></div>
</main></div></body></html>
