<?php
// Sidebar/system_administrator/dashboard.php
...
<div class="app-shell">
    ...
    <div class="main-content">
        ...
        <div class="quick-actions">
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/system_administrator/manage_users.php')) ?>">
                <strong>Manage Users</strong>
                <span>Control access and team roles</span>
            </a>
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/system_administrator/audit_log.php')) ?>">
                <strong>Review Audit Log</strong>
                <span>Investigate critical activity</span>
            </a>
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/system_administrator/fiscal_periods.php')) ?>">
                <strong>Fiscal Periods</strong>
                <span>Close or lock accounting windows</span>
            </a>
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/system_administrator/system_health.php')) ?>">
        ...
        <div class="dashboard-layout equal">
            ...
            <section class="dashboard-section"><div class="section-header"><div><h3>Inventory Value by Category</h3><p class="section-description">Current inventory cost distribution.</p></div><a href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/inventory_overview.php')) ?>">Inventory overview</a></div><canvas id="adminCategoryChart" height="125"></canvas></section>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.view-receipt-btn').forEach(function (button) {
        button.addEventListener('click', function (event) {
            ...
            fetch('<?= htmlspecialchars(app_url('Sidebar/invoice/receipt.php')) ?>?action=view&ajax=1&sale_id=' + encodeURIComponent(saleId))
