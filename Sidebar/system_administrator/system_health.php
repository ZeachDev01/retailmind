...
$service = new SystemHealthService($pdo, dirname(__DIR__, 2));
...
<section class="dashboard-section" style="margin-top:1.5rem">
    ...
    <div class="attention-list">
        <div class="attention-item"><span class="attention-icon"><i class="bi bi-database-gear"></i></span><span class="attention-copy"><strong>Apply pending migrations</strong><span><code>php scripts/migrate.php</code></span></span></div>
        <div class="attention-item"><span class="attention-icon"><i class="bi bi-shield-check"></i></span><span class="attention-copy"><strong>Run release checks</strong><span><code>bash tests/run_all.sh</code></span></span></div>
        <div class="attention-item"><span class="attention-icon"><i class="bi bi-file-earmark-zip"></i></span><span class="attention-copy"><strong>Build a clean deployment package</strong><span><code>bash scripts/build_release.sh</code></span></span></div>
    </div>
</section>
</div>
</div>
