<?php
// Sidebar/invoice/sales_history.php
...
<div class="app-shell">
    ...
    <div class="main-content">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;gap:1rem;flex-wrap:wrap;margin-bottom:1rem;">
            ...
            <a class="btn" href="<?= htmlspecialchars(app_url('Sidebar/invoice/receipt.php')) ?>">Latest Receipt</a>
        </div>
        ...
        <div style="overflow-x:auto;">
            <table>
                ...
                <tr>
                    <td><a href="<?= htmlspecialchars(app_url('Sidebar/invoice/receipt.php?sale_id=' . $sale['sale_id'])) ?>">#<?= (int)$sale['sale_id'] ?></a></td>
