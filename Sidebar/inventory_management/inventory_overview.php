<?php
// Sidebar/inventory_management/inventory_overview.php
...
<div class="app-shell">
    ...
    <div class="main-content">
        ...
        <div style="margin-top:1.5rem;display:flex;gap:1rem;flex-wrap:wrap;">
            <a class="btn" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/products.php')) ?>">Manage Products</a>
            <a class="btn" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/inventory_counts.php')) ?>">Inventory Counts</a>
