...
<header class="page-heading">
    ...
    <div class="page-heading-actions"><a class="btn btn-quiet" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/suppliers.php')) ?>">Supplier terms</a><a class="btn" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/purchase_orders.php')) ?>">Purchase orders</a></div>
</header>
