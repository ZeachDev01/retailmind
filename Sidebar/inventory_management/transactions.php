<?php
// Sidebar/inventory_management/transactions.php - Inventory Transaction History
...
$role = current_role();
$back_url = $role === 'inventory_manager' ? app_url('Sidebar/inventory_management/dashboard.php') : app_url('Sidebar/system_administrator/dashboard.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
