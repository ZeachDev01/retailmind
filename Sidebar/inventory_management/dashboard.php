...
<div class="app-shell">
    ...
    <main class="main-content">
        ...
        <div class="quick-actions">
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/products.php')) ?>"><strong><i class="bi bi-box-seam"></i> Products &amp; Stock</strong><span>Search products, print labels, and update planning settings</span></a>
            <a class="quick-action" href="<?= htmlspecialchars(app_url('Sidebar/inventory_management/replenishment_requests.php')) ?>"><strong><i class="bi bi-truck"></i> Replenishment Requests</strong><span>Approve, reject, and convert requests into purchase orders</span></a>
