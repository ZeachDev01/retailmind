...
$commandProductTarget = in_array($role, ['admin', 'super_admin', 'inventory_manager'], true) ? app_url('Sidebar/inventory_management/products.php') : app_url('cashier/pos.php');
...
$notificationItems = [
    ['path' => 'Sidebar/notification/notifications.php', 'icon' => 'bi-bell', 'label' => 'View Notifications'],
    ['path' => 'Sidebar/notification/notification_preferences.php', 'icon' => 'bi-gear', 'label' => 'Preferences'],
];

$adminSystemItems = [
    ['path' => 'Sidebar/system_administrator/manage_users.php', 'icon' => 'bi-people', 'label' => 'Manage Users'],
    ['path' => 'Sidebar/system_administrator/system_settings.php', 'icon' => 'bi-gear', 'label' => 'System Settings'],
    ['path' => 'Sidebar/system_administrator/ml_settings.php', 'icon' => 'bi-sliders', 'label' => 'ML Settings'],
    ['path' => 'Sidebar/system_administrator/backup_restore.php', 'icon' => 'bi-database-check', 'label' => 'Backup & Restore'],
    ['path' => 'Sidebar/system_administrator/system_health.php', 'icon' => 'bi-heart-pulse', 'label' => 'System Health'],
    ['path' => 'Sidebar/system_administrator/fiscal_periods.php', 'icon' => 'bi-calendar-check', 'label' => 'Fiscal Periods'],
    ['path' => 'Sidebar/system_administrator/audit_log.php', 'icon' => 'bi-clock-history', 'label' => 'Audit Log'],
];

$adminStockItems = [
    ['path' => 'Sidebar/inventory_management/inventory_overview.php', 'icon' => 'bi-boxes', 'label' => 'Inventory Overview'],
    ['path' => 'Sidebar/inventory_management/inventory_insights.php', 'icon' => 'bi-lightbulb', 'label' => 'Inventory Insights'],
    ['path' => 'Sidebar/inventory_management/products.php', 'icon' => 'bi-box-seam', 'label' => 'Products & Stock'],
    ['path' => 'Sidebar/inventory_management/transactions.php', 'icon' => 'bi-receipt', 'label' => 'Inventory Transactions'],
    ['path' => 'Sidebar/inventory_management/inventory_counts.php', 'icon' => 'bi-sliders', 'label' => 'Inventory Counts'],
    ['path' => 'Sidebar/inventory_management/csv_import.php', 'icon' => 'bi-box-arrow-in-down', 'label' => 'CSV Import'],
    ['path' => 'Sidebar/inventory_management/reorder_planner.php', 'icon' => 'bi-diagram-3', 'label' => 'Reorder Planning'],
    ['path' => 'Sidebar/inventory_management/replenishment_requests.php', 'icon' => 'bi-truck', 'label' => 'Replenishment Requests'],
    ['path' => 'Sidebar/inventory_management/suppliers.php', 'icon' => 'bi-building', 'label' => 'Suppliers'],
    ['path' => 'Sidebar/inventory_management/purchase_orders.php', 'icon' => 'bi-clipboard-check', 'label' => 'Purchase Orders'],
];

$managerInventoryItems = [
    ['path' => 'Sidebar/inventory_management/inventory_overview.php', 'icon' => 'bi-boxes', 'label' => 'Overview'],
    ['path' => 'Sidebar/inventory_management/inventory_insights.php', 'icon' => 'bi-lightbulb', 'label' => 'Insights & Risk'],
    ['path' => 'Sidebar/inventory_management/products.php', 'icon' => 'bi-box-seam', 'label' => 'Products & Stock'],
    ['path' => 'Sidebar/inventory_management/transactions.php', 'icon' => 'bi-receipt', 'label' => 'Transactions'],
    ['path' => 'Sidebar/inventory_management/inventory_counts.php', 'icon' => 'bi-sliders', 'label' => 'Inventory Counts'],
    ['path' => 'Sidebar/inventory_management/csv_import.php', 'icon' => 'bi-box-arrow-in-down', 'label' => 'CSV Import'],
    ['path' => 'Sidebar/inventory_management/reorder_planner.php', 'icon' => 'bi-diagram-3', 'label' => 'Reorder Planning'],
    ['path' => 'Sidebar/inventory_management/replenishment_requests.php', 'icon' => 'bi-truck', 'label' => 'Replenishment Requests'],
...
$adminSalesItems = [
    ['path' => 'Sidebar/invoice/receipt.php', 'icon' => 'bi-receipt', 'label' => 'Sales Transaction'],
    ['path' => 'Sidebar/invoice/reversals.php', 'icon' => 'bi-arrow-counterclockwise', 'label' => 'Sales Reversals'],
    ['path' => 'Sidebar/invoice/sales_history.php', 'icon' => 'bi-clock-history', 'label' => 'Transaction History'],
    ['path' => 'Sidebar/inventory_management/promotions.php', 'icon' => 'bi-percent', 'label' => 'Promotions'],
];

$salesHistoryItems = [
    ['path' => 'Sidebar/invoice/receipt.php', 'icon' => 'bi-receipt', 'label' => 'Sales Transaction'],
    ['path' => 'Sidebar/invoice/reversals.php', 'icon' => 'bi-arrow-counterclockwise', 'label' => 'Sales Reversals'],
    ['path' => 'Sidebar/invoice/sales_history.php', 'icon' => 'bi-clock-history', 'label' => 'Sales History'],
];
...
$adminSections = [
    [
        ...
        'items' => [
            ['path' => 'Sidebar/system_administrator/dashboard.php', 'icon' => 'bi-speedometer2', 'label' => 'Dashboard'],
...
$roleSections = [
    ...
    'inventory_manager' => [
        [
            'title' => 'Operations',
            'items' => [
                ['path' => 'Sidebar/inventory_management/dashboard.php', 'icon' => 'bi-speedometer2', 'label' => 'Dashboard'],
                ['icon' => 'bi-boxes', 'label' => 'Inventory', 'items' => $managerInventoryItems],
                [
                    'icon' => 'bi-truck',
                    'label' => 'Replenishment',
                    'items' => [
                        ['path' => 'Sidebar/inventory_management/replenishment_requests.php', 'icon' => 'bi-truck', 'label' => 'Requests'],
...
<div class="sidebar" id="appSidebar">
    ...
    <div class="sidebar-footer">
        ...
        <div class="sidebar-profile-menu" id="sidebarProfileMenu">
            <a href="<?= sidebar_e(app_url('Sidebar/notification/notification_preferences.php')) ?>"><i class="bi bi-sliders" aria-hidden="true"></i><span>Preferences</span></a>
...
<div class="command-overlay" id="commandPalette" aria-hidden="true" data-products-api="<?= sidebar_e(app_url('barcodeScanner/api/products.php')) ?>" data-product-target="<?= sidebar_e($commandProductTarget) ?>">
