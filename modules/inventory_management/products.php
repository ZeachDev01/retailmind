<?php
// modules/inventory_management/products.php
    ...
    <main class="main-content">
        <header class="page-heading">
            ...
            <div class="page-heading-actions">
                ...
                <a class="btn btn-warning btn-icon" href="<?= htmlspecialchars(app_url('modules/inventory_management/print_barcodes.php')) ?>"><i class="bi bi-upc-scan"></i>Barcode Labels</a>
            </div>
        </header>
