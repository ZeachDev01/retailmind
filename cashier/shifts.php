...
<body><div class="app-shell"><?php include __DIR__ . '/../Sidebar/sidebar.php'; ?><main class="main-content"><div class="topbar"><div><h1>Cashier Shifts</h1><p class="page-subtitle">Open the register, record pay-ins or pay-outs, and reconcile cash at closing.</p></div><?php if($openShift): ?><a class="btn" href="<?= htmlspecialchars(app_url('cashier/pos.php')) ?>">Go to POS</a><?php endif; ?></div>
