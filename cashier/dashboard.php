...
<div class="app-shell">
    ...
    <main class="main-content">
        ...
        <nav class="cashier-quick-actions" aria-label="Cashier quick actions">
            ...
            <a class="cashier-action-card" href="<?= htmlspecialchars(app_url('Sidebar/invoice/sales_history.php')) ?>">
            ...
            <a class="cashier-action-card" href="<?= htmlspecialchars(app_url('Sidebar/invoice/reversals.php')) ?>">
        ...
        <div class="cashier-dashboard-grid">
            <section class="dashboard-panel" aria-labelledby="recent-transactions-title">
                <div class="dashboard-panel-header">
                    ...
                    <a class="btn btn-small btn-secondary" href="<?= htmlspecialchars(app_url('Sidebar/invoice/sales_history.php')) ?>">View all</a>
                </div>
                    ...
                    <table class="cashier-recent-table">
                        ...
                        <?php foreach ($recentTransactions as $sale): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="receipt-link" href="<?= htmlspecialchars(app_url('Sidebar/invoice/receipt.php?sale_id=' . (int)$sale['sale_id'])) ?>">
