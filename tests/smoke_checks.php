...
$checks = [
    ...
    'Replenishment segregation of duties' => [
        'file' => 'Sidebar/inventory_management/replenishment_requests.php',
    ...
    'Release cleanup covers runtime files' => [
        ...
        'needles' => ['storage/sessions/*', 'storage/imports/*', 'demandForcasting/models/*'],
    ],
];
$failures = [];
