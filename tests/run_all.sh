...
python -m py_compile legacy/demandForcasting/train_model.py legacy/demandForcasting/auto_retrain.py legacy/demandForcasting/db.py legacy/demandForcasting/predict_api.py
