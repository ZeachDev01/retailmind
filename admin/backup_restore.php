...
<body><div class="app-shell"><?php include __DIR__ . '/../includes/sidebar.php'; ?><main class="main-content"><div class="topbar"><div><h1>Backup & Restore</h1><p class="page-subtitle">Download portable SQL backups and restore only validated RetailMind backup files.</p></div></div>
